        ...
        <div id="content">
            ...
            <div class="form">
                ...
                <fieldset class="right-col">
                    ...
                    <dl>
                        <dd>
                            <input tabindex="6" type="radio" name="tipoDaViagem" onClick="validate_radio();" value="Ida e Volta" /></dd></dl>
                    <dl>
                        <dd>
                            <input tabindex="7" type="text" name="origem" id="origem" class="input-l autocomplete-city" onBlur="validate_city('origem');"/></dd>
                    </dl>
                    <dl>
                        <dd>
                            <input tabindex="8" type="text" name="destino" id="destino" class="input-l autocomplete-city" onBlur="validate_city('destino');"/></dd>
                    </dl>
                    <dl>
                        <dd>
                ...
                <div class="half-col" start="2">
                    ...
                    <fieldset>
                        <dl>
                            <dd>
                                <input tabindex="10" type="text" id="ida" name="dataIda" class="input-s datepicker" />
                ...
                <div class="button-col-2">
                    <input type="button" class="btn-blue" value="Inserir Datas" name="inserirDatas" onClick="validate_date();"/>
                </div>
                <div class="list-date">
