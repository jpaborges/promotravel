    	...
    	<div id="templatemo_middle_column">
          ...
          <div class="section2_top"><h2>Passagens</h2></div>
               ...
               <div id="suggest" style="visibility:hidden;border:#000000 1px solid;width:150px;z-index:100"></div>
                ...
                <div class="form_row">
                    <li>
                        <label title="Coloque o email que deseja receber a informação da passagem" class="desc" > Email <span class="req">*</span></label>
                        <div><input title="Coloque o email que deseja receber a informação da passagem" id="email" name="email" type="text" class="field text medium" value="" maxlength="255" tabindex="5" required /></div>
                    </li>
                </div>
				...
				<div class="form_row">               
                	<li class="date leftHalf">
                        ...
                        <input style="background-image:url(images/calendar.jpg); height: 20px; width: 20px;" type="button" onclick="displayCalendar(document.forms[0].theDate,'dd/mm/yyyy',this)" title="Tente em dias da semana diferentes – não é só você que quer viajar na sexta a noite e voltar na segunda bem cedinho. Se você começar pesquisando nesses dias pode não encontrar a menor tarifa. Tente datas que caiam na segunda-feira, na terça-feira, na quarta-feira e no sábado"/>                        
					</li>
                </div>
                ...
                <div class="form_row">                      
  				...
  				<div class="form_row">
  					<li>
                        ...
                        <select rows="10" cols="50" tabindex="8"  class="field textarea medium" name="languages" size="10" id="selOriginalWindow" style="width:300px; height: 70px;"	multiple="multiple" ondblclick="alterarDataDblClique()"></select>
	                </li>
 				</div>
  
				<div class="form_row">
                	<li>
                		<label title="Coloque aqui o preço que deseja pagar nas passagens com origens e destinos solicitados" class="desc">Preço Esperado<span class="req">*</span></label>
                		<span class="symbol">R$</span>
               			<input id="preco_esperado" title="Coloque aqui o preço que deseja pagar nas passagens com origens e destinos solicitados" name="preco_esperado" onclick="getPrecoMedio()" onfocus="getPrecoMedio()" onkeypress="return formatar_moeda(this,',','.',event);" type="text" class="field text currency nospin" value="" size="10" tabindex="9" />  
