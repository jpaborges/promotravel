          ...
          <div class="section2_top"><h2>Passagens</h2></div>
                ...
                <div class="form_row">
                    ...
                    <li class="twoColumns">
                        ...
                        <fieldset>
                            ...
                            <input class="field radio" type="Radio" name="Tipo" value="Somente Ida" onchange="check()" tabindex="1" checked="checked"/>
                            ...
                            <input class="field radio" type="Radio" name="Tipo" value="Ida e Volta" onchange="check()" tabindex="2" />
               ...
               <div id="suggest" style="visibility:hidden;border:#000000 1px solid;width:150px;z-index:100"></div>
                    ...
                    <li>
                        ...
                        <input id="origem" name="origem" type="text" style="border:#000000 1px solid;width:150px;" autocomplete=off class="field text fn" value="" size="15" tabindex="3" required />
                        ...
                        <input id="destino" name="destino" type="text" style="border:#000000 1px solid;width:150px;" autocomplete=off class="field text ln" value="" size="15" tabindex="4" required />
				...
				<div class="form_row">               
                	...
                	<li class="date leftHalf">
                		...
                		<label class="desc">Data de partida</label>

                        <input tabindex="6" type="text" class="inputfield" readonly name="theDate" id="ida" onclick="displayCalendar(document.forms[0].theDate,'dd/mm/yyyy',this)">

                        <input style="background-image:url(images/calendar.jpg); height: 20px; width: 20px;" type="button"  onclick="displayCalendar(document.forms[0].theDate,'dd/mm/yyyy',this)">                        
				...
				<div class="form_row">
                	...
                	<li class="date rightHalf">
                		...
                		<label class="desc">Data de volta</label>

                        <input tabindex="7" type="text" class="inputfield" readonly id="volta" name="theDate2" onclick="displayCalendar(document.forms[0].theDate2,'dd/mm/yyyy',this)" disabled="disabled">

                        <input id="voltabt" style="background-image:url(images/calendar.jpg); height: 20px; width: 20px;" type="button" onclick="displayCalendar(document.forms[0].theDate2,'dd/mm/yyyy',this)" disabled="disabled">
				...
				<div class="form_row">
                	...
                	<li>
                		...
                		<span class="symbol">R$</span>
               			...
               			<input id="preco_esperado" name="preco_esperado"  onkeypress="return formatar_moeda(this,',','.',event);" type="text" class="field text currency nospin" value="" size="10" tabindex="9" />              
...
<!--Toda essa bagunca eh o nomezinho embaixo, favor nao mecher aqui...  INICIO -->        
	...
	<div id="templatemo_footer">
            ...
            <a href="#">Home</a> | <a href="#">Sobre</a> | <a href="#">Promoções</a> | <a href="#">Fale Conosco</a><br />
