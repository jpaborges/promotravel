...
<!-- start of middle column -->
    	...
    	<div id="templatemo_middle_column" class="auto-style1" style="width: 450px">
    	  <div id="section2">
                         
                <form method="post" action="tratamento.php" id="myForm" name="myForm" autocomplete=off>
                <div class="section2_top" style="margin-left: 0px"><h2>Sobre:</h2></div>
                <div class="form_row">
                
                	<br />
                    Imagine viajar se planejando e não tendo a necessidade de 
					fazer busca constantes por passagens. <br />
					A PromoTravel tornou isso possível. Utilizando-a você é 
					capaz de cadastrar destinos, datas e preços desejados e o 
					sistema se responsabiliza por procurar, periodicamente, 
					essas passagens e informar via email caso encontre-as, assim 
					você não ficará mais refém da mudança constante dos preços 
					das passagens.<br />
					<br />
					</div>
                
			   <div class="section2_top" style="margin-left: 0px"><h2>Como utilizar:</h2></div>
                             
                               
                <div class="form_row">
                	<br />
                    1- Escolha se deseja passagens com apenas ida ou ida e 
					volta;<br />
					2- Selecione a origem e o destino;<br />
					3- Preencha o email que irá receber as informações sobre a 
					passagem desejadas;<br />
					4- Escolha a(s) data(s). Você pode escolher mais de uma 
					data.<br />
					5- Clique em adicionar para cada data desejada;<br />
					6- Coloque o preço que deseja pagar;<br />
					7- Clique em buscar.<br />
					Após clicar em buscar você irá receber um email para 
					confirmação. Caso não confirme em até x dias, a pesquisa 
					será cancelada.<br />
					Assim que uma passagem for encontrada com as datas 
					escolhidas, a origem e destinos selecionado e o preço 
					desejado, você receberá um email com essas informações.
					<br />
                </div>            	
                </form>
